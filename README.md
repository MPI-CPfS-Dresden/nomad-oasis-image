![docker image](https://github.com/MPI-CPfS-Dresden/nomad-oasis-image/actions/workflows/docker-publish.yml/badge.svg)


# MPI-CPfS-Dresden's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of MPI-CPfS-Dresden.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/MPI-CPfS-Dresden/nomad-oasis-image.git
    ...
    ```sh
    curl-L -o nomad-oasis-image.zip "https://github.com/MPI-CPfS-Dresden/nomad-oasis-image/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/mpi-cpfs-dresden/nomad-oasis-image:main` for the services
...
```
docker pull ghcr.io/mpi-cpfs-dresden/nomad-oasis-image/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/MPI-CPfS-Dresden/nomad-oasis-image/manifests/main": unauthorized`
